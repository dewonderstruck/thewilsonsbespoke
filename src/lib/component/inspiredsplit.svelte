<div class="w-screen flex h-screen bg-[#0d0d0d] text-white">
    ...
    <div class="w-1/2 p-24 ml-16 flex flex-col justify-center">
      <h1 class="text-5xl font-bold mb-4 text-start max-w-2xl leading-normal">Exquisite Designs Crafted by Experts</h1>
