<script>
    const suits = [
      {
        name: "Bespoke Suits",
        image: "https://cdn.media.amplience.net/i/tom_ford/2EYHT1-WOS09_HB790_OS_A?w=2560"
      },
      {
        name: "Canvas Suits",
        image: "https://cdn.media.amplience.net/i/tom_ford/2EYHT1-WOS09_HB790_OS_A?w=2560"
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-6 bg-black/80">
    {#each suits as suit}
